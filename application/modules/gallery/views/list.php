				...
				<div class="box">
					<div class="box-header">
						<?php if ($this->session->userdata('uroleid') != USER) { ?>
							<a href="<?php echo site_url('manage/gallery/add') ?>" class="btn btn-sm btn-success"><i class="fa fa-plus"></i> Tambah</a>
						<?php } ?>
						<!-- /.box-header -->
							...
							<table id="dtable" class="table table-hover">
								...
								<tbody>
									...
									?>
											<tr>
												<td><?php echo $i; ?></td>
												<td><img src="<?= base_url() . 'uploads/galleries/' . $row['img']; ?>" alt="" width="50px"></td>
												<td>
												...
												<div class="modal-dialog">
													<div class="modal-content">
														...
														<div class="modal-body">
															...
															<p><img src="<?= base_url() . 'uploads/galleries/' . $row['img']; ?>" alt="" width="70%"></p>
														</div>
														<div class="modal-footer">
															<?php echo form_open('manage/gallery/delete'); ?>
