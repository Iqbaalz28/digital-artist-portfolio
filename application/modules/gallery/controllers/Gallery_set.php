...
class Gallery_set extends CI_Controller
{
  ...
  {
    $config['upload_path'] = FCPATH . 'uploads/galleries/';
    ...
    foreach ($_FILES['img']['name'] as $key => $value) {
      ...
      if ($this->upload->do_upload('userfile')) {
        ...
        $this->session->set_flashdata('failed', 'Tambah Gallery Gagal');
      }
    }
  ...
  public function delete()
  {
    if ($_POST) {
      ...
      $this->session->set_flashdata('success', 'Hapus Item Gallery berhasil');
      redirect('manage/gallery');
    } elseif (!$_POST) {
