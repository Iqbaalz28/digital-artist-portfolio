				...
				<div class="box">
					<div class="box-header">
						<?php if ($this->session->userdata('uroleid') != USER) { ?>
							<a href="<?php echo site_url('manage/blog/add') ?>" class="btn btn-sm btn-success"><i class="fa fa-plus"></i> Tambah</a>
						<?php } ?>
						<!-- /.box-header -->
							...
							<table id="dtable" class="table table-hover">
								...
								<tbody>
									...
									?>
											<tr>
												<td><?php echo $i; ?></td>
												<td><img src="<?= base_url() . 'uploads/blogs/' . $row['foto']; ?>" alt="" width="50px"></td>
												<td><?php echo $row['judul']; ?></td>
												<td><?php echo $row['slug']; ?></td>
												<td><?php echo createSummary($row['konten']); ?></td>
												<td><?php echo $row['full_name']; ?></td>
												<td>
													<a href="<?php echo site_url('manage/blog/edit/' . $row['id']) ?>" class="btn btn-xs btn-warning" data-toggle="tooltip" title="Edit"><i class="fa fa-edit"></i></a>
												</td>
											</tr>
										<?php
											$i++;
